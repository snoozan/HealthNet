...
urlpatterns = [
    ...
    url(r'^record/update/(?P<recordid>[0-9]+)/$', views.updateTestResult, name='update_record'),
    url(r'^record/view/(?P<patientid>[0-9]+)/$', views.viewTestResult, name='view_record'),
    url(r'^record/view/$', views.viewTestResult, name='view_record')
]